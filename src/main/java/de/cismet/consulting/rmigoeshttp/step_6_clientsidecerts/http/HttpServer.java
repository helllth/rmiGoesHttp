    ...
    private HttpServer() {
        ...
        server = new org.mortbay.jetty.Server();
         try {
                ...
                ssl.setKeystore("/Users/thorsten/dev/810-rmiGoesHttp/server.keystore");
                ssl.setPassword("123demostorepass");
                ssl.setKeyPassword("123demokeypass");
                
                ssl.setTruststore("/Users/thorsten/dev/810-rmiGoesHttp/truststore.keystore");
                ssl.setTrustPassword("123trusstorepass");
                
                boolean csc=true;
                ssl.setWantClientAuth(csc);
                ssl.setNeedClientAuth(csc);
